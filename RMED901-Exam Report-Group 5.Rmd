...
```
#Looking at the data distribution first. There is no line. So we remove E-10212 bla bla (scientific notations on decimals). We then make the model for indometachin vs risk of pancreatitis. 
