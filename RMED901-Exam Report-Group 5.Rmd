...
#Then we create datafram (df1) of these three columns and then plot a correlation matrix.
```{r}
library(corrplot)
...
#t looks like there is an higher number of older patients with Type2. 
